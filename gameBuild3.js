...
var rect1 = {x: 400, dx: -2, y: 25, dy: 1, w: 20, h: 20};
...
function collisionDetection(player,x,y,w,h) {
    var distX = Math.abs(player.x - x - w/2);
    var distY = Math.abs(player.y - y - h/2);

    if (distX > (w/2 + player.r)) { return false; }
    if (distY > (h/2 + player.r)) { return false; }
...
if (player.lives) {
  if(collisionDetection(player,rect1.x,rect1.y,rect1.w,rect1.h)) {
    player.lives--;
    player.x = canvas.width/2; 
    player.y = canvas.height-15;
  }
  if(collisionDetection(player,rect2.x,rect2.y,rect2.w,rect2.h)) {
    player.lives--;
    player.x = canvas.width/2; 
    player.y = canvas.height-15;
  }
  if(collisionDetection(player,rect3.x,rect3.y,rect3.w,rect3.h)) {
    player.lives--;
    player.x = canvas.width/2; 
    player.y = canvas.height-15;
  }
  if(collisionDetection(player,rect4.x,rect4.y,rect4.w,rect4.h)) {
    player.lives--;
    player.x = canvas.width/2; 
    player.y = canvas.height-15;
  }
  if(collisionDetection(player,rect5.x,rect5.y,rect5.w,rect5.h)) {
    player.lives--;
    player.x = canvas.width/2; 
    player.y = canvas.height-15;
  }
...
if (rect1.x + rect1.dx > canvas.width-35) {
  rect1.dx = -rect1.dx;
}
if (rect1.x + rect1.dx <= 15) {
  rect1.dx = -rect1.dx;
}
...
if (rect2.x + rect2.dx > canvas.width-35) {
  rect2.dx = -rect2.dx;
}
if (rect2.x + rect2.dx <= 15) {
  rect2.dx = -rect2.dx;
}
...
if (rect3.x + rect3.dx > canvas.width-35) {
  rect3.dx = -rect3.dx;
}
if (rect3.x + rect3.dx <= 15) {
  rect3.dx = -rect3.dx;
}
...
if (rect4.x + rect4.dx > canvas.width-35) {
  rect4.dx = -rect4.dx;
}
if (rect4.x + rect4.dx <= 15) {
  rect4.dx = -rect4.dx;
}
...
if (rect5.x + rect5.dx > canvas.width-35) {
  rect5.dx = -rect5.dx;
}
if (rect5.x + rect5.dx <= 15) {
  rect5.dx = -rect5.dx;
}
